                        ...
                        if (response === "100" || response === "") {
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    //}
                                    $('<b style="display: block;">Congratulations! Your project is successfully provisioned.</b>' + proceedOrg + docLink).appendTo("#accountLink");
                                    $('#dvProgress').removeClass("d-block").addClass("d-none");
                                    $('#textMuted').removeClass("d-block").addClass("d-none");
                                    currentPercentage = 0;
                            ...
                            if (ErrorData !== '') {
                                ...
                                $('<b style="display: block;">We ran into some issues and we are sorry about that!</b><p> The log below will provide you insights into why the provisioning failed. </p><p>Click on View Diagnostics button to see captured error logs</p>').appendTo("#errorDescription");
