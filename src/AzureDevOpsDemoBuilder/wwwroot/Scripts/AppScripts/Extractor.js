                    ...
                    $.get(url2, function (response) {
                        ...
                        if (response === "100" || response === "") {
                            ...
                            if (ErrorData !== '') {
                                ...
                                $("#projCreateMsg").hide();
                                $('<b style="display: block;">We ran into some issues and we are sorry about that!</b><p> The log below will provide you insights into why the provisioning failed. </p><p>Click on View Diagnostics button to see the error logs captured</p>').appendTo("#errorDescription");
                                $('#GenerateArtifacts').removeClass('lodergif');
                                //$('#ExdvProgress').removeClass("d-block").addClass("d-none");
