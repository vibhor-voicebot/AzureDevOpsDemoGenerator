    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                string AppScope = "vso.agentpools_manage vso.code_manage vso.dashboards_manage vso.extension_manage vso.identity vso.project_manage vso.release_manage vso.serviceendpoint_manage vso.test_write vso.wiki_write vso.work_full";
