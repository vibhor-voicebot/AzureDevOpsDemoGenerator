...
namespace AzureDevOpsDemoBuilder.Services
{
    public class ExtractorService : IExtractorService
    {
        ...
        public ProjectConfigurations ProjectConfiguration(Project model)
        {
            ...
            projectConfig.BuildDefinitionConfig = new AppConfiguration() { UriString = "https://dev.azure.com/" + model.AccountName + "/", PersonalAccessToken = model.AccessToken, Project = model.ProjectName, AccountName = model.AccountName, Id = model.Id, VersionNumber = buildVersion };
